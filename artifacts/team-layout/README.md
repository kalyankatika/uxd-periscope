...
Grouping is ownership, not allocation. Group counts differ from selecting a leader's broader related-project scope. Cross-group edges are suppressed until an endpoint is selected or hovered; the original overview suppression was removed after user review; nodes and within-group edges now remain visible at every zoom level.
